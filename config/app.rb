...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'cinema-lab.com'
  config.app_name = 'Cinema-lab'
  config.mailer.from = 'Cinema-lab <no-reply@cinema-lab.com>'
  ...
  #
  config.app_secret = 'qsBH9Gog7jDrG2ub3ii2_DNc_tJ-cOzMeg5niMiv1L2ZrQCbvE6rEMCsbsStYadlkLE'
